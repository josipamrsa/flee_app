package com.example.fleeapp.domain.use_case.get_featured_tracks
...
class GetFeaturedTracksUseCase @Inject constructor(
    ...
    operator fun invoke(
        ...
        flow {
            try {
                ...
                val tracks = repository.getFeaturedTracks().map { it.toTrack() }
