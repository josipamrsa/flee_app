package com.example.fleeapp.domain.use_case.get_acoustic_only_tracks
...
class GetAcousticOnlyTracksUseCase @Inject constructor(
    ...
    operator fun invoke(
        ...
        flow {
            try {
                ...
                val tracks = repository.getAcousticOnlyTracks().map { it.toTrack() }
